...
{
    //INITIALLISATION DES VOITURES DANS UNE VARIBLE STRUCTURE GRACE A LA FONCTION <strcpy> QUI EST UNE FONCTION QUI PERMET DE COPIER DES CHAINES DE CARACTERES DANS UNE VARIABLE
